...
public class EmployeeAllDetailController {
    ...
    // create employee details REST API
    @PostMapping
    ...
    public ResponseEntity<EmployeeAllDetail> updateEmployeeAllDetail(@PathVariable long id,@RequestBody EmployeeAllDetail employeeAllDetail) {
        ...
        updateEmployeeAllDetail.setId(employeeAllDetail.getId());
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<HttpStatus> deleteEmployeeAllDetail(@PathVariable long id){
